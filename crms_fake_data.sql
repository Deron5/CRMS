...
INSERT INTO `customers` (`customer_id`, `first_name`, `surname`, `email`, `phone_number`, `drivers_license`, `license_issue_location`, `license_expiration_date`, `prefered_vehicle`, `rental_duration`, `prefered_dropoff`, `preferred_pickup`, `password`, `role`) VALUES (57, 'Hallie', 'O\'Reilly', 'josue49@example.com', '+85(9)097319871', '57 ul', NULL, '2010-04-29', NULL, NULL, NULL, NULL, '137c90ac46a8446464f62e9c5', NULL);
